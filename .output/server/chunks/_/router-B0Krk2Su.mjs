...
const common$1 = { "app_name": "PAYKA", "search_placeholder": "Search Jewelry", "categories": "Categories", "we_recommend": "We Recommend", "add_to_cart": "Add to Cart", "checkout": "Checkout", "save_for_later": "Save for later", "move_to_cart": "Move to cart", "remove": "Remove", "subtotal": "Subtotal", "total": "Total", "favorites": "Favorites", "cart": "Cart", "about_us": "About Us", "no_items": "No items found", "price": "Price", "metal": "Metal", "color": "Color", "apply": "Apply", "reset": "Reset", "back": "Back", "category_names": { "Bangles": "Bangles", "Rings": "Rings", "Earrings": "Earrings", "Pendants": "Pendants" } };
const catalog$1 = { "title": "Catalog", "advanced_filters": "Advanced Filters", "price_range": "Price Range", "min": "Min", "max": "Max" };
const product$1 = { "add_to_favorites": "Add to favorites", "added_to_cart": "Added to cart", "description": "Description", "descriptions": { "ring_plava": "Freedom that needs no explanation", "diamond_eternity_ring": "Stunning diamond eternity ring", "lollypop_rings": "Beautifully crafted embossed earrings", "silver_pendant": "Minimalist silver pendant", "classic_gold_ring": "Classic gold ring" }, "names": { "ring_plava": "PLAVA Ring", "diamond_eternity_ring": "Diamond Eternity Ring", "lollypop": "🍭", "silver_pendant": "Silver Pendant", "gold_ring": "Gold Ring" }, "details": "Details", "about_product": "About Product", "select_size": "Select Size", "select_ring_size": "Select Ring Size", "size_in_mm": "Size is shown in millimeters (mm)", "select_stone": "Select Stone", "select_stone_color": "Select Color", "recommended_for_you": "Recommended for you", "sku": "SKU", "metal_standard": "Metal Standard", "metal_type": "Metal Type", "metal_color": "Metal Color", "clasp": "Clasp", "gemstone": "Gemstone", "design": "Design", "style": "Style", "product_type": "Product Type", "technology": "Technology", "width": "Width, mm", "thickness": "Thickness, mm", "length": "Length, mm", "weight": "Weight, g" };
...
const checkout$1 = { "title": "Checkout", "shipping_info": "Shipping Information", "full_name": "Full Name", "phone": "Phone Number", "city": "City", "department": "Nova Poshta Department", "search_city": "Search city...", "select_department": "Select department...", "shipping_method": "Shipping Method", "estimated_delivery": "Estimated delivery: {{time}}", "address": "Shipping Address", "order_summary": "Order Summary", "place_order": "Place Order", "back_to_cart": "Back to Cart", "confirm_order": "Confirm Your Order", "subtotal": "Subtotal", "shipping": "Shipping", "total": "Total", "errors": { "name_required": "Full name is required", "phone_invalid": "Invalid phone number format", "address_required": "Shipping address is required", "city_required": "Please select a city", "department_required": "Please select a department", "consent_required": "Please confirm consent to process your personal data", "submit_failed": "Unable to submit your order. Please try again." }, "methods": { "nova_poshta": "Nova Poshta (to Department)" }, "success": "Order placed successfully! Securely encrypted during transmission.", "encrypt_note": "Your data is encrypted using 256-bit SSL security.", "privacy_title": "Data Protection", "privacy_note": "We collect only the information needed to fulfill your order. Personal data is transmitted securely to our team and processed solely for order fulfillment in accordance with GDPR.", "privacy_consent": "I agree to the processing of my personal data for order fulfillment.", "submitting": "Submitting order..." };
...
const common = { "app_name": "PAYKA", "search_placeholder": "Пошук прикрас", "categories": "Категорії", "we_recommend": "Ми рекомендуємо", "add_to_cart": "Додати в кошик", "checkout": "Оформити замовлення", "save_for_later": "Зберегти на потім", "move_to_cart": "Перемістити в кошик", "remove": "Видалити", "subtotal": "Підсумок", "total": "Разом", "favorites": "Обране", "cart": "Кошик", "about_us": "Про нас", "no_items": "Товари не знайдені", "price": "Ціна", "metal": "Метал", "color": "Колір", "apply": "Застосувати", "reset": "Скинути", "back": "Назад", "category_names": { "Bangles": "Браслети", "Rings": "Каблучки", "Earrings": "Сережки", "Pendants": "Підвіски" } };
const catalog = { "title": "Каталог", "advanced_filters": "Розширені фільтри", "price_range": "Діапазон цін", "min": "Від", "max": "До" };
const product = { "add_to_favorites": "Додати в обране", "added_to_cart": "Додано в кошик", "description": "Опис", "descriptions": { "ring_plava": "Cвобода, яка не потребує пояснень", "diamond_eternity_ring": "Приголомшлива каблучка з діамантами", "lollypop_rings": "Якщо б літо можна було носити на пальці, воно виглядало б саме так 🍭", "silver_pendant": "Мінімалістична срібна підвіска", "classic_gold_ring": "Класична золота каблучка" }, "names": { "ring_plava": "Кільце PLAVA", "diamond_eternity_ring": "Каблучка з діамантами Eternity", "lollypop": "Каблучка льодяник", "silver_pendant": "Срібна підвіска", "gold_ring": "Золота каблучка" }, "details": "Деталі", "about_product": "Про виріб", "select_size": "Оберіть розмір", "select_ring_size": "Оберіть розмір каблучки", "size_in_mm": "Розмір вказано в міліметрах (мм)", "select_stone": "Оберіть камінь", "select_stone_color": "Оберіть колір", "recommended_for_you": "Рекомендовано для вас", "sku": "Артикул", "metal_standard": "Проба", "metal_type": "Метал", "metal_color": "Колір металу", "clasp": "Застібка", "gemstone": "Вставка", "design": "Дизайн", "style": "Стиль", "product_type": "Тип виробу", "technology": "Технологія виготовлення", "width": "Ширина, мм", "thickness": "Товщина, мм", "length": "Довжина, мм", "weight": "Вага, г" };
...
const checkout = { "title": "Оформлення", "shipping_info": "Інформація про доставку", "full_name": "Повне ім'я", "phone": "Номер телефону", "city": "Місто", "department": "Відділення Нової Пошти", "search_city": "Пошук міста...", "select_department": "Оберіть відділення...", "shipping_method": "Спосіб доставки", "estimated_delivery": "Очікувана доставка: {{time}}", "address": "Адреса доставки", "order_summary": "Підсумок замовлення", "place_order": "Оформити замовлення", "back_to_cart": "Назад до кошика", "confirm_order": "Підтвердіть замовлення", "subtotal": "Вартість товарів", "shipping": "Доставка", "total": "Разом", "errors": { "name_required": "Повне ім'я обов'язкове", "phone_invalid": "Невірний формат номера телефону", "address_required": "Адреса доставки обов'язкова", "city_required": "Оберіть місто", "department_required": "Оберіть відділення", "consent_required": "Будь ласка, підтвердіть згоду на обробку персональних даних", "submit_failed": "Не вдалося надіслати замовлення. Спробуйте ще раз." }, "methods": { "nova_poshta": "Нова Пошта (до відділення)" }, "success": "Замовлення успішно оформлено! Дані захищені шифруванням під час передачі.", "encrypt_note": "Ваші дані зашифровані за допомогою 256-бітного протоколу безпеки SSL.", "privacy_title": "Захист даних", "privacy_note": "Ми збираємо лише інформацію, необхідну для виконання вашого замовлення. Персональні дані передаються нашій команді безпечно та обробляються виключно для виконання замовлення відповідно до GDPR.", "privacy_consent": "Я погоджуюся на обробку моїх персональних даних для виконання замовлення.", "submitting": "Надсилання замовлення..." };
...
const appCss = "/assets/styles-C-9sKkd1.css";
...
const $$splitComponentImporter$6 = () => import("./favorites-OL6VcQ59.mjs");
const Route$6 = createFileRoute("/favorites")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./checkout-C5eThR-W.mjs");
...
const $$splitComponentImporter$4 = () => import("./catalog-C2BIkwrj.mjs");
...
const $$splitComponentImporter$3 = () => import("./cart-e7o6i2a-.mjs");
...
const $$splitComponentImporter = () => import("./product._productId-BW31i98w.mjs");
...
const routerB0Krk2Su = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  R: Route$4,
  a: useCart,
  b: Route,
