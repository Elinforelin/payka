...
import { g as getCategoriesWithProducts, a as getCategoryCoverImage } from "./data-CZl5DixN.mjs";
import { r as resolveProductImageUrl } from "./product-images-XBZXgYgm.mjs";
import { R as Route$2, g as getEffectivePrice, d as getProductPricing } from "./router-DTeC6Cxg.mjs";
import { g as getCharityPercent, H as Heart, P as ProductPrice } from "./ProductPrice-BQSkTEaE.mjs";
import { M as MiniCart } from "./MiniCart-DK6qkOaf.mjs";
import { I as Info, S as SlidersHorizontal, C as Check, P as ProductCard } from "./ProductCard-DpG3k7h8.mjs";
import { u as useBodyScrollLock, X } from "./use-body-scroll-lock-B7pwx_nM.mjs";
...
function CatalogPage() {
  ...
  const filteredProducts = (productsData || []).filter((product) => {
    ...
    const matchesPrice = getEffectivePrice(product) >= minPrice && getEffectivePrice(product) <= maxPrice;
    const matchesMetalType = selectedMetalTypes.length === 0 || product.metalType && selectedMetalTypes.includes(product.metalType);
    const matchesOffers = !filterOnSale && !filterCharity || filterOnSale && getProductPricing(product).isOnSale || filterCharity && getCharityPercent(product) !== null;
  ...
  return /* @__PURE__ */ jsxs("main", { className: "min-h-screen bg-[#fdfaf7] px-6 py-8 md:px-12", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative flex-1", children: [
        ...
        showSuggestions && suggestions.length > 0 && /* @__PURE__ */ jsx("div", { className: "absolute top-full left-0 right-0 z-50 mt-2 rounded-2xl bg-white p-2 shadow-xl border border-gray-100", children: suggestions.map((suggestion) => /* @__PURE__ */ jsxs(Link, { to: "/product/$productId", params: {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
            ...
            /* @__PURE__ */ jsx(ProductPrice, { product: suggestion, size: "sm" })
          ] })
        ] }, suggestion.id)) })
      ] }),
    ...
    showFilters && /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[60] flex justify-end", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative h-full w-full max-w-sm bg-white p-8 shadow-2xl animate-in slide-in-from-right duration-300 overflow-y-auto", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "mt-1 text-xs text-[#a19690]", children: t("catalog.price_range_hint", {
            min: catalogMinPrice,
            max: catalogMaxPrice
          }) }),
          /* @__PURE__ */ jsxs("div", { className: "mt-4 flex items-center gap-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              ...
              /* @__PURE__ */ jsx("input", { type: "text", inputMode: "numeric", pattern: "[0-9]*", value: priceRange[0], placeholder: String(catalogMinPrice), onChange: (e) => {
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex-1", children: [
              ...
              /* @__PURE__ */ jsx("input", { type: "text", inputMode: "numeric", pattern: "[0-9]*", value: priceRange[1], placeholder: String(catalogMaxPrice), onChange: (e) => {
                let val = e.target.value.replace(/[^0-9]/g, "");
                if (val.length > 1 && val.startsWith("0")) {
                  val = val.replace(/^0+/, "");
                }
        ...
        /* @__PURE__ */ jsxs("div", { className: "mt-8", children: [
          /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-[#1a1a1a]", children: t("catalog.offers") }),
          /* @__PURE__ */ jsxs("div", { className: "mt-4 flex flex-wrap gap-2", children: [
            /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => setFilterOnSale((prev) => !prev), className: `flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition-all ${filterOnSale ? "bg-[#e85d4c] text-white" : "bg-[#fdfaf7] text-[#6b5f59]"}`, children: [
              filterOnSale && /* @__PURE__ */ jsx(Check, { className: "h-3 w-3" }),
              t("common.sale")
            ] }),
            /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => setFilterCharity((prev) => !prev), className: `flex items-center gap-2 rounded-full px-4 py-2 text-sm font-medium transition-all ${filterCharity ? "bg-[#5a7a5c] text-white" : "bg-[#fdfaf7] text-[#6b5f59]"}`, children: [
              filterCharity && /* @__PURE__ */ jsx(Check, { className: "h-3 w-3" }),
    ...
    categories.length > 0 && /* @__PURE__ */ jsxs("section", { className: "mt-8 md:mt-10", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mt-6 flex gap-3 md:gap-4", children: categories.map((category) => {
        const coverImage = getCategoryCoverImage(category);
        return /* @__PURE__ */ jsxs(Link, { to: "/catalog/$category", params: {
          category
        }, className: "group relative aspect-square min-w-0 flex-1 cursor-pointer overflow-hidden rounded-2xl bg-[#f7f3ef] shadow-sm transition-all duration-300 ease-out hover:scale-[1.02] hover:shadow-md", children: [
          coverImage ? /* @__PURE__ */ jsx("img", { src: resolveProductImageUrl(coverImage), alt: t(`common.category_names.${category}`), className: "h-full w-full object-cover transition-transform duration-300 ease-out group-hover:scale-105" }) : /* @__PURE__ */ jsx("div", { className: "h-full w-full bg-[#e8dfd8]" }),
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 bg-black/30 transition-colors duration-300 group-hover:bg-black/40" }),
          /* @__PURE__ */ jsx("div", { className: "absolute inset-0 flex items-center justify-center p-3 md:p-4", children: /* @__PURE__ */ jsx("span", { className: "text-center text-[11px] sm:text-xs md:text-sm font-ermilov font-bold uppercase tracking-[0.12em] text-white", children: t(`common.category_names.${category}`) }) })
        ] }, category);
      }) })
    ] }),
