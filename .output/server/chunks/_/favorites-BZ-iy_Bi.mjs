...
import { u as useFavorites, a as useCart } from "./router-CNsBLqJP.mjs";
...
function FavoritesPage() {
  ...
  return /* @__PURE__ */ jsxs("main", { className: "min-h-screen bg-[#fdfaf7] px-6 py-8 md:px-12", children: [
    /* @__PURE__ */ jsxs("header", { className: "flex items-center justify-between mb-8", children: [
      /* @__PURE__ */ jsx(Link, { to: "/catalog", className: "flex h-12 w-12 items-center justify-center rounded-2xl bg-white shadow-sm", children: /* @__PURE__ */ jsx(ChevronLeft, { className: "h-6 w-6 text-[#1a1a1a]" }) }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-8 flex items-center gap-3 overflow-x-auto pb-2 no-scrollbar", children: [
      ...
      categories.map((cat) => /* @__PURE__ */ jsxs("button", { onClick: () => setActiveCategory(cat), className: `whitespace-nowrap rounded-full px-6 py-2.5 text-sm font-bold transition-all ${activeCategory === cat ? "bg-[#b3917d] text-white shadow-md" : "bg-white text-[#6b5f59] hover:bg-[#f7f3ef]"}`, children: [
        cat,
        " (",
    ...
    /* @__PURE__ */ jsx("div", { className: "mx-auto max-w-4xl", children: filteredFavorites.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center rounded-[48px] bg-white p-16 text-center shadow-sm", children: [
      ...
      /* @__PURE__ */ jsx(Link, { to: "/catalog", className: "mt-8 rounded-2xl bg-[#1a1a1a] px-8 py-4 font-bold text-white shadow-lg transition-transform hover:scale-105", children: t("about.explore_collection") })
      ...
      /* @__PURE__ */ jsxs(Link, { to: "/product/$productId", params: {
        ...
        /* @__PURE__ */ jsx("img", { src: resolveProductImageUrl(product.imageUrl), alt: product.name, className: "h-full w-full object-cover transition-transform duration-500 group-hover:scale-110" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "mt-4 flex flex-1 flex-col justify-between px-2 pb-2", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-[#1a1a1a] group-hover:text-[#b3917d] transition-colors", children: product.name }),
