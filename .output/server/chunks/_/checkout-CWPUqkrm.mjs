...
import { c as createLucideIcon, a as useCart, C as CircleCheck, b as createSsrRpc } from "./router-D4PKThx1.mjs";
...
function CheckoutPage() {
  ...
  const getSubmitErrorMessage = (error) => {
    ...
    if (error.message === ORDER_DELIVERY_FAILED || error.message.includes("Email is not configured")) {
      return t("checkout.errors.submit_failed");
    }
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsx("div", { className: "space-y-6", children: step === "shipping" ? /* @__PURE__ */ jsx("div", { className: "bg-white rounded-[32px] p-6 md:p-8 shadow-sm space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsx("input", { type: "tel", autoComplete: "tel", inputMode: "tel", name: "tel", value: formData.phone, onChange: (e) => setFormData({
            ...formData,
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-[#6b5f59] mb-2 px-1", children: t("checkout.email") }),
          /* @__PURE__ */ jsx("input", { type: "email", autoComplete: "email", value: formData.email, onChange: (e) => setFormData({
            ...formData,
