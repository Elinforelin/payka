...
import { a as useCart } from "./router-CNsBLqJP.mjs";
  ...
  return /* @__PURE__ */ jsxs("main", { className: "min-h-screen bg-[#fdfaf7] px-6 py-8 md:px-12", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-2xl", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-4 mb-8", children: activeItems.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "rounded-[32px] bg-white p-12 text-center shadow-sm", children: [
        ...
        /* @__PURE__ */ jsx(Link, { to: "/catalog", className: "mt-4 inline-block font-bold text-[#b3917d] hover:underline", children: t("cart.continue_shopping") })
        ...
        }, className: "h-24 w-24 flex-shrink-0 overflow-hidden rounded-2xl bg-[#f7f3ef]", children: /* @__PURE__ */ jsx("img", { src: resolveProductImageUrl(item.imageUrl), alt: item.name, className: "h-full w-full object-cover" }) }),
        /* @__PURE__ */ jsxs("div", { className: "flex-1 text-center sm:text-left", children: [
          /* @__PURE__ */ jsx(Link, { to: "/product/$productId", params: {
            productId: String(item.id)
          }, className: "text-base md:text-lg font-bold text-[#1a1a1a] hover:text-[#b3917d] transition-colors", children: item.name }),
