...
import { c as createLucideIcon, a as useCart, C as CircleCheck, b as createSsrRpc } from "./router-B0Krk2Su.mjs";
  ...
  return /* @__PURE__ */ jsxs("main", { className: "min-h-screen bg-[#fdfaf7] px-6 py-8 md:px-12 pb-24", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "lg:sticky lg:top-8 h-fit space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[32px] p-6 md:p-8 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsx("button", { onClick: step === "shipping" ? handleNext : handlePlaceOrder, disabled: isSubmitting, className: "w-full mt-8 rounded-[24px] bg-[#1a1a1a] py-4 md:py-5 text-base md:text-lg font-bold text-white shadow-xl transition-all hover:bg-black active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed", children: step === "shipping" ? /* @__PURE__ */ jsx(Fragment, { children: "Next Step" }) : isSubmitting ? /* @__PURE__ */ jsxs(Fragment, { children: [
