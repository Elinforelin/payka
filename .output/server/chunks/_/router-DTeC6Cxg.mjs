...
import { C as Category, p as products } from "./data-CZl5DixN.mjs";
...
const CartProvider = ({ children }) => {
  ...
  const addToCart = (product, selectedStone, selectedSize, selectedStoneColor) => {
    ...
    setItems((prevItems) => {
      ...
      return [
        ...prevItems,
        { ...pricedProduct, quantity: 1, savedForLater: false, selectedStone, selectedStoneColor, selectedSize }
      ];
    });
    if (notificationTimeoutRef.current) {
      clearTimeout(notificationTimeoutRef.current);
...
const Notification = () => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "fixed bottom-8 left-1/2 z-[100] w-[calc(100%-2rem)] max-w-md -translate-x-1/2 animate-in fade-in slide-in-from-bottom-4 duration-300", children: /* @__PURE__ */ jsxs("div", { className: "rounded-[24px] bg-white px-5 py-4 shadow-2xl ring-1 ring-[#f0ebe7]", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3", children: [
      /* @__PURE__ */ jsx(CircleCheck, { className: "mt-0.5 h-5 w-5 shrink-0 text-[#b3917d]" }),
      /* @__PURE__ */ jsx("p", { className: "font-bold tracking-tight leading-snug text-[#1a1a1a]", children: t(notification.key, notification.params) })
    ] }),
...
const appCss = "/assets/styles-Dwa0xXJa.css";
...
const $$splitComponentImporter$8 = () => import("./shipping-Yeoob5Rj.mjs");
...
const $$splitComponentImporter$6 = () => import("./favorites-CAM8t6Q-.mjs");
const Route$7 = createFileRoute("/favorites")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./checkout-BuuFSCai.mjs");
const Route$6 = createFileRoute("/checkout")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./cart-Duyix6rK.mjs");
...
const $$splitComponentImporter$2 = () => import("./index-Bcrypdl_.mjs");
...
const $$splitComponentImporter$1 = () => import("./product._productId-DAfugDZj.mjs");
...
const $$splitComponentImporter = () => import("./catalog._category-BJis_KeE.mjs");
...
const routerDTeC6Cxg = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  R: Route$2,
  a: useCart,
  b: getProductPricing,
