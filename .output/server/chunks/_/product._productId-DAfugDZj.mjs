...
import { c as createLucideIcon, e as Route$1, a as useCart, u as useFavorites } from "./router-DTeC6Cxg.mjs";
import { M as MiniCart } from "./MiniCart-DK6qkOaf.mjs";
import { u as useBodyScrollLock, X } from "./use-body-scroll-lock-B7pwx_nM.mjs";
import { C as ChevronDown, a as ShippingReturnsGuide, R as Ruler } from "./ShippingReturnsInfo-DCpkIMUt.mjs";
import { L as LanguageToggle } from "./LanguageToggle-_RTdtCBY.mjs";
import { H as Heart, D as DiscountBadge, C as CharityBadge, a as CharityNote, P as ProductPrice, S as ShoppingBag } from "./ProductPrice-BQSkTEaE.mjs";
  ...
  return /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[70] flex items-end sm:items-center justify-center", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative w-full sm:max-w-lg max-h-[90vh] overflow-y-auto bg-white rounded-t-[32px] sm:rounded-[32px] p-6 md:p-8 shadow-2xl", children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "mt-8", children: [
        /* @__PURE__ */ jsxs("h3", { className: "flex items-center gap-2 text-base font-bold text-[#1a1a1a] mb-3", children: [
          /* @__PURE__ */ jsx(Gem, { className: "h-4 w-4 text-[#b3917d]" }),
            ...
            (() => {
              ...
              return /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col gap-1", children: [
                ...
                /* @__PURE__ */ jsxs("button", { disabled: !canAddToCart, onClick: () => {
                  const stoneTypeLabel = selectedStoneType ? t(`stones.types.${selectedStoneType}`) : void 0;
                  const stoneColorLabel = selectedStoneType && allStoneColorsSelected ? stoneCount > 1 ? selectedStoneColors.map((color, i) => `${i + 1}. ${t(`stones.colors.${color.name}`)}`).join(", ") : t(`stones.colors.${selectedStoneColor.name}`) : void 0;
                  addToCart(product, stoneTypeLabel, selectedSize ?? void 0, stoneColorLabel);
