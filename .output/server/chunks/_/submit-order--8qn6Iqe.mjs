...
function formatItemLine(item) {
  ...
  return `- ${item.name} (ID: ${item.id}) x${item.quantity} — ₴${lineTotal}`;
}
    ...
    <table style="border-collapse:collapse;width:100%;max-width:640px;">
      <thead>
        <tr>
          ...
          <th align="left" style="padding:8px;border-bottom:2px solid #b3917d;">ID</th>
          <th align="left" style="padding:8px;border-bottom:2px solid #b3917d;">Qty</th>
          <th align="left" style="padding:8px;border-bottom:2px solid #b3917d;">Unit</th>
