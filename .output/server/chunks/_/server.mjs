...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-BemA7ft4.mjs");
...
async function getEntries() {
  if (cachedRouterEntry === null) {
    cachedRouterEntry = await import("./router-CNsBLqJP.mjs").then(function(n) {
      return n.r;
    }).then((n) => n.r);
  }
