...
import { c as createLucideIcon, a as useCart, C as CircleCheck } from "./router-CNsBLqJP.mjs";
...
function CheckoutPage() {
  ...
  const shippingMethods = [{
    ...
    id: "standard",
    name: t("checkout.methods.standard"),
    price: 0,
    time: "3-5 business days"
  }, {
    id: "express",
    name: t("checkout.methods.express"),
    price: 15,
    time: "1-2 business days"
  }, {
    id: "pickup",
    name: t("checkout.methods.pickup"),
    price: 0,
    time: "Today"
  }];
  useEffect(() => {
  ...
  if (activeItems.length === 0 && step !== "success") {
    return /* @__PURE__ */ jsx("main", { className: "min-h-screen bg-[#fdfaf7] px-6 py-8 flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      ...
      /* @__PURE__ */ jsx(Link, { to: "/catalog", className: "text-[#b3917d] font-bold hover:underline", children: t("cart.continue_shopping") })
    ] }) });
  }
  if (step === "success") {
    return /* @__PURE__ */ jsx("main", { className: "min-h-screen bg-[#fdfaf7] px-6 py-12 md:py-24 flex items-center justify-center", children: /* @__PURE__ */ jsxs("div", { className: "max-w-md w-full bg-white rounded-[40px] p-8 md:p-12 shadow-sm text-center", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "text-2xl md:text-3xl font-bold text-[#1a1a1a] mb-4", children: t("checkout.success") }),
      /* @__PURE__ */ jsx("p", { className: "text-[#6b5f59] mb-8 leading-relaxed", children: t("checkout.encrypt_note") }),
      /* @__PURE__ */ jsx(Link, { to: "/catalog", className: "block w-full rounded-[24px] bg-[#1a1a1a] py-4 text-white font-bold transition-all hover:bg-black", children: t("cart.continue_shopping") })
    ] }) });
  }
  return /* @__PURE__ */ jsxs("main", { className: "min-h-screen bg-[#fdfaf7] px-6 py-8 md:px-12 pb-24", children: [
    /* @__PURE__ */ jsxs("header", { className: "flex items-center justify-between mb-8 max-w-4xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "w-10 md:w-12" })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-8", children: [
      /* @__PURE__ */ jsx("div", { className: "space-y-6", children: step === "shipping" ? /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[32px] p-6 md:p-8 shadow-sm space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            ...
            }), className: `w-full h-14 rounded-2xl bg-[#fdfaf7] px-4 outline-none border-2 transition-all ${errors.fullName ? "border-red-200 focus:border-red-400" : "border-transparent focus:border-[#b3917d]"}`, placeholder: "John Doe" }),
          ...
          selectedMethod === "nova_poshta" ? /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "relative", ref: citySearchRef, children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsx("input", { type: "text", value: citySearch, onChange: (e) => {
        ...
        /* @__PURE__ */ jsxs("div", { className: "pt-4", children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-lg font-bold text-[#1a1a1a] mb-4 flex items-center gap-2", children: [
            /* @__PURE__ */ jsx(Truck, { className: "h-5 w-5 text-[#b3917d]" }),
            t("checkout.shipping_method")
          ] }),
          /* @__PURE__ */ jsx("div", { className: "space-y-3", children: shippingMethods.map((method) => /* @__PURE__ */ jsxs("button", { onClick: () => setSelectedMethod(method.id), className: `w-full flex items-center justify-between p-4 rounded-2xl border-2 transition-all ${selectedMethod === method.id ? "border-[#b3917d] bg-[#fdfaf7]" : "border-transparent bg-[#fdfaf7]/50 hover:bg-[#fdfaf7]"}`, children: [
            /* @__PURE__ */ jsxs("div", { className: "text-left", children: [
              /* @__PURE__ */ jsx("div", { className: "font-bold text-[#1a1a1a]", children: method.name }),
              /* @__PURE__ */ jsx("div", { className: "text-xs text-[#6b5f59]", children: method.time })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "font-bold text-[#b3917d]", children: method.price === 0 ? "Free" : `$${method.price}` })
          ] }, method.id)) })
        ] })
        ...
        /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[32px] p-6 md:p-8 shadow-sm", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-sm text-[#6b5f59] leading-relaxed", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "lg:sticky lg:top-8 h-fit space-y-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-[32px] p-6 md:p-8 shadow-sm", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "max-h-64 overflow-y-auto pr-2 space-y-4 mb-8 custom-scrollbar", children: activeItems.map((item) => /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
          /* @__PURE__ */ jsx("div", { className: "h-16 w-16 flex-shrink-0 overflow-hidden rounded-xl bg-[#f7f3ef]", children: /* @__PURE__ */ jsx("img", { src: resolveProductImageUrl(item.imageUrl), alt: item.name, className: "h-full w-full object-cover" }) }),
          /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsx("p", { className: "text-sm font-bold text-[#1a1a1a] truncate", children: item.name }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-3 pt-6 border-t border-gray-100", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-[#6b5f59]", children: [
            /* @__PURE__ */ jsx("span", { children: t("checkout.shipping") }),
            /* @__PURE__ */ jsx("span", { children: currentMethod.price === 0 ? "Free" : `$${currentMethod.price}` })
          ] }),
        ...
        /* @__PURE__ */ jsx("button", { onClick: step === "shipping" ? handleNext : handlePlaceOrder, className: "w-full mt-8 rounded-[24px] bg-[#1a1a1a] py-4 md:py-5 text-base md:text-lg font-bold text-white shadow-xl transition-all hover:bg-black active:scale-[0.98] flex items-center justify-center gap-2", children: step === "shipping" ? /* @__PURE__ */ jsx(Fragment, { children: "Next Step" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
