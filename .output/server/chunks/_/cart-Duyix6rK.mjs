...
import { a as useCart } from "./router-DTeC6Cxg.mjs";
  ...
  return /* @__PURE__ */ jsxs("main", { className: "min-h-screen bg-[#fdfaf7] px-6 py-8 md:px-12", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-2xl", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-4 mb-8", children: activeItems.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "rounded-[32px] bg-white p-12 text-center shadow-sm", children: [
        ...
        const stoneType = item.selectedStoneColor ? item.selectedStone : item.selectedStone?.includes(": ") ? item.selectedStone.split(": ")[0] : item.selectedStone;
        const stoneColor = item.selectedStoneColor ?? (item.selectedStone?.includes(": ") ? item.selectedStone.split(": ").slice(1).join(": ") : void 0);
        return /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center sm:items-start gap-4 rounded-[32px] bg-white p-4 shadow-sm", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex-1 text-center sm:text-left", children: [
            ...
            stoneType && /* @__PURE__ */ jsxs("p", { className: "text-xs text-[#a19690]", children: [
              t("cart.stone"),
              ": ",
              /* @__PURE__ */ jsx("span", { className: "font-medium text-[#6b5f59]", children: stoneType })
            ] }),
            stoneColor && /* @__PURE__ */ jsxs("p", { className: "text-xs text-[#a19690]", children: [
              t("cart.stone_color"),
              ": ",
              /* @__PURE__ */ jsx("span", { className: "font-medium text-[#6b5f59]", children: stoneColor })
            ] }),
