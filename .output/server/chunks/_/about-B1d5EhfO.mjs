...
function AboutPage() {
  ...
  return /* @__PURE__ */ jsxs("main", { className: "min-h-screen bg-[#fdfaf7] px-6 py-8 md:px-12", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-3xl space-y-12", children: [
      ...
      /* @__PURE__ */ jsxs("section", { className: "rounded-[40px] bg-white p-8 md:p-12 shadow-sm border border-[#f0ebe7]", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
          /* @__PURE__ */ jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-xl bg-[#f7f3ef] text-[#b3917d]", children: /* @__PURE__ */ jsx(Mail, { className: "h-6 w-6" }) }),
          /* @__PURE__ */ jsx("h2", { className: "text-2xl font-bold text-[#1a1a1a]", children: t("about.contact_us") })
        ] }),
        /* @__PURE__ */ jsx("p", { className: "text-[#6b5f59] mb-8 max-w-xl", children: t("about.contact_desc") }),
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("a", { href: CONTACT_INFO.instagram.url, target: "_blank", rel: "noopener noreferrer", className: "flex flex-col items-center gap-3 rounded-[24px] bg-[#f7f3ef] p-6 text-center transition-transform hover:scale-[1.02] active:scale-[0.98]", children: [
            /* @__PURE__ */ jsx("div", { className: "flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-[#b3917d] shadow-sm", children: /* @__PURE__ */ jsx(Instagram, { className: "h-6 w-6" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs uppercase tracking-[0.2em] text-[#a19690] font-bold", children: t("about.instagram") }),
              /* @__PURE__ */ jsxs("p", { className: "mt-1 text-sm font-semibold text-[#1a1a1a]", children: [
                "@",
                CONTACT_INFO.instagram.handle
              ] })
            ] })
          ] }),
          /* @__PURE__ */ jsxs("a", { href: `mailto:${CONTACT_INFO.email}`, className: "flex flex-col items-center gap-3 rounded-[24px] bg-[#f7f3ef] p-6 text-center transition-transform hover:scale-[1.02] active:scale-[0.98]", children: [
            /* @__PURE__ */ jsx("div", { className: "flex h-12 w-12 items-center justify-center rounded-2xl bg-white text-[#b3917d] shadow-sm", children: /* @__PURE__ */ jsx(Mail, { className: "h-6 w-6" }) }),
            /* @__PURE__ */ jsxs("div", { children: [
              /* @__PURE__ */ jsx("p", { className: "text-xs uppercase tracking-[0.2em] text-[#a19690] font-bold", children: t("about.email") }),
              /* @__PURE__ */ jsx("p", { className: "mt-1 text-sm font-semibold text-[#1a1a1a] break-all", children: CONTACT_INFO.email })
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsx("div", { className: "mt-8 text-center", children: /* @__PURE__ */ jsx(Link, { to: "/shipping", className: "text-sm font-bold text-[#b3917d] underline underline-offset-4 hover:text-[#9a7a68] transition-colors", children: t("about.shipping_returns_link") }) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "rounded-[40px] bg-[#efe6df] p-8 md:p-10 text-center space-y-4", children: [
        ...
        /* @__PURE__ */ jsx(Link, { to: "/", className: "inline-block rounded-full bg-[#1a1a1a] px-8 py-4 text-base md:text-lg font-bold text-white shadow-xl transition-transform hover:scale-105 active:scale-95", children: t("about.explore_collection") })
      ] })
    ] })
  ] });
}
