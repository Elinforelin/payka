...
import { c as createLucideIcon, a as useCart } from "./router-CNsBLqJP.mjs";
import { r as resolveProductImageUrl } from "./product-images-BN7C3qV1.mjs";
import { Link } from "@tanstack/react-router";
import { S as ShoppingBag } from "./shopping-bag.mjs";
          ...
          savedItems.length > 0 && /* @__PURE__ */ jsxs("div", { className: "pt-4", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "space-y-4 opacity-70", children: savedItems.map((item) => /* @__PURE__ */ jsxs("div", { className: "flex gap-4", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "flex flex-1 flex-col justify-center", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-sm font-bold text-[#1a1a1a]", children: item.name }),
                  /* @__PURE__ */ jsx(
                    "button",
                    {
                      onClick: () => removeFromCart(item.id),
