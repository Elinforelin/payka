import { createRouter, createRootRoute, createFileRoute, Navigate, lazyRouteComponent, notFound, redirect, HeadContent, Scripts } from "@tanstack/react-router";
...
import { C as Category, p as products } from "./data-B1DXlOW8.mjs";
...
const appCss = "/assets/styles-h9wN0LI4.css";
...
const $$splitComponentImporter$6 = () => import("./favorites-COUpXgna.mjs");
const Route$7 = createFileRoute("/favorites")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./checkout-DcHyVoIJ.mjs");
const Route$6 = createFileRoute("/checkout")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./cart-A73hUosj.mjs");
const Route$5 = createFileRoute("/cart")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./about-C_BynoNC.mjs");
...
const $$splitComponentImporter$2 = () => import("./index-A8qmqqpj.mjs");
...
const $$splitComponentImporter$1 = () => import("./product._productId-C4lUbhGz.mjs");
...
const $$splitComponentImporter = () => import("./catalog._category-BzMlx4mw.mjs");
const Route = createFileRoute("/catalog/$category")({
  loader: async ({
    ...
    return {
      category,
      products: products.filter((product2) => product2.category === category)
    };
  },
...
const routerCIvSAii = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  R: Route$2,
  a: useCart,
  b: Route$1,
